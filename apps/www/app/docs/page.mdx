export const metadata = {
  ...
  description:
    "Complete documentation for Audexis, a powerful audio metadata editor for macOS. Learn how to edit ID3 tags, manage album art, batch rename files, and organize your music library.",
  keywords:
