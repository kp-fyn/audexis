export const metadata = {
  ...
  description:
    "Advanced configuration options for Audexis. Learn how to customize settings, manage preferences, and configure the application to your workflow.",
  keywords:
    "audexis config, user preferences, configuration file, advanced settings, app customization",
};
