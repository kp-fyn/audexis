...
export default function ImageContextMenu() {
  ...
  const noAttatchedImage =
    currentFile.attachedPicture === null && !changes.attachedPicture?.buffer;
  return (
    <>
      <ContextMenuItem
        onClick={async () => {
      ...
      <ContextMenuItem disabled={noAttatchedImage}>
        Save to FIle
      </ContextMenuItem>
      <ContextMenuSeparator />
      <ContextMenuItem disabled={noAttatchedImage}>
      ...
      <ContextMenuSub>
        <ContextMenuSubTrigger disabled={noAttatchedImage}>
          Set Image Type{" "}
        </ContextMenuSubTrigger>
        <ContextMenuSubContent>
          <ContextMenuRadioGroup
